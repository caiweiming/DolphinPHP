...
CREATE TABLE `dp_admin_app` (
  ...
  `lifecycle_status` varchar(32) NOT NULL DEFAULT 'imported' COMMENT '生命周期状态: imported/installed',
...
INSERT INTO `dp_admin_config` (`id`, `app`, `group`, `title`, `key`, `type`, `value`, `default_value`, `options`, `rules`, `remark`, `sort`, `status`, `is_system`, `create_time`, `update_time`) VALUES (2, 'admin', '登录设置', '登录页欢迎标题', 'login.welcome_title', 'text', '登录您的帐户', '登录您的帐户', '', 'require|max:100', '显示在后台登录页表单卡片顶部。', 100, 1, 1, 1774488030, 1774488030);
INSERT INTO `dp_admin_config` (`id`, `app`, `group`, `title`, `key`, `type`, `value`, `default_value`, `options`, `rules`, `remark`, `sort`, `status`, `is_system`, `create_time`, `update_time`) VALUES (3, 'admin', '登录设置', '登录验证码', 'login.enable_captcha', 'switch', '1', '1', '', '', '控制后台登录页是否显示并校验验证码，关闭后登录时不再要求输入验证码。', 110, 1, 1, 1774490554, 1774490554);
INSERT INTO `dp_admin_config` (`id`, `app`, `group`, `title`, `key`, `type`, `value`, `default_value`, `options`, `rules`, `remark`, `sort`, `status`, `is_system`, `create_time`, `update_time`) VALUES (4, 'admin', '上传设置', '默认上传驱动', 'upload.default_driver', 'select', 'local', 'local', '{\"options\":{\"local\":\"本地存储\",\"aliyun\":\"阿里云 OSS\",\"qiniu\":\"七牛云存储\"}}', 'require', '用于所有支持上传驱动的表单项默认值；表单项显式配置 driver 时优先生效，未配置时回退到此项，再回退到静态 upload.default。', 300, 1, 1, 1774490554, 1774512941);
INSERT INTO `dp_admin_config` (`id`, `app`, `group`, `title`, `key`, `type`, `value`, `default_value`, `options`, `rules`, `remark`, `sort`, `status`, `is_system`, `create_time`, `update_time`) VALUES (12, 'admin', '安全设置', '登录失败重试次数', 'security.login_max_retries', 'number', '5', '5', '', 'integer|egt:0', '单个账号允许连续登录失败的最大次数，0 表示关闭失败锁定。', 200, 1, 1, 1778716800, 1778716800);
INSERT INTO `dp_admin_config` (`id`, `app`, `group`, `title`, `key`, `type`, `value`, `default_value`, `options`, `rules`, `remark`, `sort`, `status`, `is_system`, `create_time`, `update_time`) VALUES (13, 'admin', '安全设置', '登录失败限制时间（分钟）', 'security.login_lock_minutes', 'number', '30', '30', '', 'integer|egt:0', '达到失败次数上限后的账号锁定时长，单位分钟；仅在启用失败锁定时生效。', 210, 1, 1, 1778716800, 1778716800);
INSERT INTO `dp_admin_config` (`id`, `app`, `group`, `title`, `key`, `type`, `value`, `default_value`, `options`, `rules`, `remark`, `sort`, `status`, `is_system`, `create_time`, `update_time`) VALUES (14, 'admin', '安全设置', '无响应自动退出时间（分钟）', 'security.idle_logout_minutes', 'number', '15', '15', '', 'integer|egt:0', '后台连续无操作达到该时长后自动退出，0 表示关闭空闲退出。', 220, 1, 1, 1778716800, 1778716800);
INSERT INTO `dp_admin_config` (`id`, `app`, `group`, `title`, `key`, `type`, `value`, `default_value`, `options`, `rules`, `remark`, `sort`, `status`, `is_system`, `create_time`, `update_time`) VALUES (15, 'admin', '安全设置', '密码有效期（天）', 'security.password_expire_days', 'number', '90', '90', '', 'integer|egt:0', '密码有效期天数，本轮仅配置化，不强制改密。', 230, 1, 1, 1778716800, 1778716800);
COMMIT;
...
CREATE TABLE `dp_admin_user` (
  ...
  `create_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `update_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '更新时间',
  `password_updated_time` int(11) unsigned NOT NULL DEFAULT '0' COMMENT '密码更新时间',
...
-- ----------------------------
BEGIN;
INSERT INTO `dp_admin_user` (`id`, `username`, `nickname`, `password`, `email`, `email_verify`, `mobile`, `phone_verify`, `department_id`, `avatar`, `role`, `status`, `is_super_admin`, `login_count`, `create_time`, `update_time`, `password_updated_time`, `delete_time`, `reg_ip`, `last_login_time`, `last_login_ip`, `sort`, `next_login_time`, `session_id`, `remember_selector`, `remember_token_hash`, `remember_expires_at`, `remark`) VALUES (1, 'admin', '超级管理员23', '$2y$10$rMHXE2ECj2.2a/TrMSJ.KOwXyqMpTLWP2WaxFMOqTZ.ZQvcXC4y2y', '', 0, '13609030141', 0, 0, 0, 1, 1, 1, 0, 1595216929, 1776940594, 1776940594, NULL, '', 1777272962, '::1', 100, 0, '', '', '', 0, '行政村');
COMMIT;
