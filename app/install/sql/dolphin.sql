...
INSERT INTO `dp_admin_config` (`id`, `app`, `group`, `title`, `key`, `type`, `value`, `default_value`, `options`, `rules`, `remark`, `sort`, `status`, `is_system`, `create_time`, `update_time`) VALUES (5, 'admin', '上传设置', '附件上传提示文案', 'upload.attachment_tip', 'textarea', '当前默认驱动：{driver}。图片 {image_limit}，视频 {video_limit}，音频 {audio_limit}，文件 {file_limit}。文件上传成功后会自动写入附件表。', '当前默认驱动：{driver}。图片 {image_limit}，视频 {video_limit}，音频 {audio_limit}，文件 {file_limit}。文件上传成功后会自动写入附件表。', '', 'max:500', '支持占位符：{driver}、{image_limit}、{video_limit}、{audio_limit}、{file_limit}。', 40, 1, 1, 1774490554, 1774490554);
COMMIT;
