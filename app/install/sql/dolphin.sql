...
INSERT INTO `dp_admin_config` (`id`, `app`, `group`, `title`, `key`, `type`, `value`, `default_value`, `options`, `rules`, `remark`, `sort`, `status`, `is_system`, `create_time`, `update_time`) VALUES (4, 'admin', '上传设置', '默认上传驱动', 'upload.default_driver', 'select', 'local', 'local', '{\"options\":{\"local\":\"本地存储\",\"aliyun\":\"阿里云 OSS\",\"qiniu\":\"七牛云存储\"}}', 'require', '用于所有支持上传驱动的表单项默认值；表单项显式配置 driver 时优先生效，未配置时回退到此项，再回退到静态 upload.default。', 30, 1, 1, 1774490554, 1774512941);
COMMIT;
