...
class Amap extends FormType
{
     ...
     * @return $this
     */
    public function securityJsCode(string $code): static
    {
        $this->config['options']['securityJsCode'] = $code;
        return $this;
    }
}
